...
function csn_show_form(){
    ...
    <form name='csn_user_news' id='csn_form' action='<?php echo $new_uri ?>' method="post">
        ...
        <ul>
            ...
            <li>
                <label for='csn_user_title'>Submission Title:</label>
                <input type='text' name='csn_user_title' id='csn_user_title'/>
            </li>
            <li>
                <label for='csn_user_story'>Submission Content:</label>
                <textarea name='csn_user_story' rows='25' cols='60' id='csn_user_story'></textarea>
            </li>
            <li>
