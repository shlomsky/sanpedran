...
class MnglProfilesController
{
  ...
  {
    $activity_types['profile_updates'] = array( 'name'    => 'Profile Updates',
  ...
  function directory($dir_page,$user_search=false,$search_query='',$dir_page_size=25)
  {
    ...
    require_once MNGL_VIEWS_PATH . "/mngl-profiles/directory.php";
  }
  ...
  function profile($user_screenname='')
  {
        ...
        $user = MnglUser::get_stored_profile())
    {
      ...
      require_once MNGL_VIEWS_PATH . "/mngl-profiles/profile.php";
    }
  ...
  function activity()
  {
    ...
    if( MnglUser::is_logged_in_and_visible() and 
        $user = MnglUser::get_stored_profile() )
      require_once MNGL_VIEWS_PATH . "/mngl-profiles/activity.php";
    else
      require_once MNGL_VIEWS_PATH . "/shared/unauthorized.php";
  }
  ...
  function edit()
  {  
    global $mngl_user, $mngl_blogurl, $mngl_board_post;
    ...
    if(MnglUser::is_logged_in_and_visible())
    {
      ...
      if(isset($_POST['action']) and $_POST['action'] == 'process_form')
      {
        ...
        if(count($errors) <= 0)
        {
          ...
          do_action('mngl-profile-update');

          $mngl_board_post->add_activity_by_id( $mngl_user->id, $mngl_user->id, 'profile_updates' );

          require_once MNGL_VIEWS_PATH . "/mngl-profiles/profile_saved.php";
        }
        else
          require_once MNGL_VIEWS_PATH . "/shared/errors.php";
      }
      
      require_once MNGL_VIEWS_PATH . "/mngl-profiles/edit.php";
    }
    else
      require_once MNGL_VIEWS_PATH . "/shared/unauthorized.php";
  }
  ...
  function delete_avatar($user_id)
  {
    ...
    if(MnglUser::is_logged_in_and_visible() and $user_id==$mngl_user->id)
    {
      ...
      require_once MNGL_VIEWS_PATH . "/mngl-profiles/edit_avatar.php";
    }
  }
}
?>
