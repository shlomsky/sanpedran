      ...
      <tr>
        ...
        <td valign="top" class="mngl-valign-top">
          <div class="mngl-board-comment-message">
            <a href="<?php echo $comment_author->get_profile_url(); ?>"><?php echo "{$comment_author->screenname}"; ?></a> <?php MnglBoardsHelper::display_message('mngl-board-comment-message-'.$comment->id, $comment->message); ?><br/>
            ...
            if(($mngl_user->id == $board_post->owner_id) or ($mngl_user->id == $comment->author_id) or current_user_can('level_10'))
            {
