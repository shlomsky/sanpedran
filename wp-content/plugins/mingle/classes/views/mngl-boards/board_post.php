    ...
    <tr>
      ...
      <td valign="top" style="width: 100%;" class="mngl-valign-top">
        <div class="mngl-board-post-message">
          <?php echo $author_profile_link; ?> <?php MnglBoardsHelper::display_message('mngl-board-post-message-'.$board_post->id, $board_post->message); ?><br/>
...
?>
    <div id="mngl-board-comment-list-<?php echo $board_post->id; ?>" class="mngl-board-comment-list<?php echo ((count($board_post->comments) >= 1)?"":" mngl-hidden"); ?>">
    <?php
