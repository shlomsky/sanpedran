...
function create_poll_table() {
	...
	add_option('poll_template_voteheader', '<p style="text-align: left;padding:10px 0 0 10px;"><strong>%POLL_QUESTION%</strong></p>'.
	...
	'<p style="text-align: left;padding:10px 0 0 10px;"><input type="button" name="vote" value="   '.__('Vote', 'wp-polls').'   " class="Buttons" onclick="poll_vote(%POLL_ID%);" /></p>'.
	'<p style="text-align: left;padding-left:10px;"><a href="#ViewPollResults" onclick="poll_result(%POLL_ID%); return false;" title="'.__('View Results Of This Poll', 'wp-polls').'">'.__('View Results', 'wp-polls').'</a></p>'.
	'</div>', 'Template For Poll\'s Voting Footer');
	add_option('poll_template_resultheader', '<p style="text-align: left;padding:10px 0 0 10px;"><strong>%POLL_QUESTION%</strong></p>'.
	'<div id="polls-%POLL_ID%-ans" class="wp-polls-ans">'.
